...
// ------------------------------------------------------------------------------------------------------------------
const ApplicantProject = sequelize.define("APPLICANT_PROJECT", {
    ApplicantUsername: {
        type: DataTypes.STRING(32),
        allowNull: false,
        unique: "actions_unique",
...
// ------------------------------------------------------------------------------------------------------------------
const ApplicantCertification = sequelize.define("APPLICANT_CERTIFICATION", {
    ApplicantUsername: {
        type: DataTypes.STRING(32),
        primaryKey: true,
        allowNull: false,
...
// ------------------------------------------------------------------------------------------------------------------
const ApplicantSkill = sequelize.define("APPLICANT_SKILL", {
    ApplicantUsername: {
        type: DataTypes.STRING(32),
        primaryKey: true,
        allowNull: false,
...
// ------------------------------------------------------------------------------------------------------------------
const ApplicantCompetition = sequelize.define("APPLICANT_COMPETITION", {
    ApplicantUsername: {
        type: DataTypes.STRING(32),
        primaryKey: true,
        allowNull: false,
